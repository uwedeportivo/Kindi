...
func (c *Consumer) Post(url string, body string, bodytype string, userParams map[string]string, token *AccessToken) (resp *http.Response, err os.Error) {
	return c.makeAuthorizedRequest("POST", url, body, bodytype, userParams, token)
}
...
func (c *Consumer) makeAuthorizedRequest(method string, url string, body string, bodytype string,
	userParams map[string]string, token *AccessToken) (resp *http.Response, err os.Error) {
	...
	return c.httpExecute(method, url+queryParams, body, bodytype, authParams)	
}
...
func (c* Consumer) httpExecute(
	method string, url string, body string, bodytype string, oauthParams *OrderedParams) (*http.Response, os.Error) {
